...
public class MenuCard extends JPanel {
    ...
    private final Consumer<dtosanpham> clickEvent;
    private boolean isSelected = false;
    private JPanel panelHeader;
    private JPanel panelBody;
    
    
    public MenuCard(dtosanpham sp, Consumer<dtosanpham> event_sp, Consumer<dtosanpham> clickEvent) {
        this.sp = sp;
