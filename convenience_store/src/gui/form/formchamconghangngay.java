...
public class formchamconghangngay extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        myTextField1.addActionListener(evt -> myTextField1ActionPerformed(evt));
        ...
        myTextField2.addActionListener(evt -> myTextField2ActionPerformed(evt));
        ...
        button2.addActionListener(evt -> button2ActionPerformed(evt));
        ...
        button3.addActionListener(evt -> button3ActionPerformed(evt));
        ...
        button5.addActionListener(evt -> button5ActionPerformed(evt));
        ...
        combobox1.addActionListener(evt -> combobox1ActionPerformed(evt));
        ...
        chucVuTextField.addActionListener(evt -> chucVuTextFieldActionPerformed(evt));
        ...
        maNVTextField.addActionListener(evt -> maNVTextFieldActionPerformed(evt));
        ...
        diaChiTextField.addActionListener(evt -> diaChiTextFieldActionPerformed(evt));
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        if(myTextField1.getText().isEmpty()){
            ...
            if (cc == null) {
                ...
                newCC.setSongaylamviec(0);
                newCC.setSogiolamthem(0);
                newCC.setChitiet("");
                buscc.create(newCC);
                buscc.getlist();
                cc = buscc.get(cc);
    ...
    private void button5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button5ActionPerformed
        ...
        if(myTextField2.getText().isEmpty()){
            ...
            dtochitietchamcong ctcc = busctcc.getctcc(day, cc.getMachamcong());
            if (ctcc == null) {
                JOptionPane.showMessageDialog(this, "Không tìm thấy chi tiết chấm công để check-out.");
                return;
            }
    ...
    private gui.comp.Combobox<String> combobox1;
